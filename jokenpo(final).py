        ...
        if modo <= 0 or modo >= 5: # esse serve para caso a pessoa escoha uma opção nao valida ele tente novamente.
                ...
                while True:
                        if modo == 1: # caso a pessoa escoha o modo 1
                                ...
                                if escolha == "pedra" and escolha2 == "tesoura": # essa parte serve para ver qual jogador ganhou a rodada.
                                        print("\n--------------------------------------------")
                                ...
                                #PLAYER 2 VENCENDO
                                        ...
                                        print("--------------------------------------------")
                                        pontos_player2 += 1
                                elif escolha == "pedra" and escolha2 == "papel":
                                        print("\n--------------------------------------------")
                                        print("            \033[1;31mPlayer 2 venceu!\033[0m")
                                        print("--------------------------------------------")
                                        pontos_player2 += 1
                                        ...
                                        print("\n--------------------------------------------")
                                        print("            \033[1;32mPlayer 2 venceu!\033[0m")
                                        print("--------------------------------------------")
                                        pontos_player1 += 1
                                ...
                                print(f"\n\033[1;37mPlacar:\033[0m \033[1;32mPlayer 1 =\033[0m \033[1;37m{pontos_player1}\033[0m | \033[1;31mPlayer 2 =\033[0m \033[1;37m{pontos_player2}\033[0m")
                                
                                # Essa parte serve para perguntar se ele quer jogar novamente quando uma partida terminar
                                ...
                                #caso não queira, exibe mensagem de tchau
                                ...
                                #Caso não queira, exibe mensagem de tcahu
                                elif jogar_novamente == "n":
                                        print("\n\033[1;37mObrigado por jogar! Estudantes: Felipe Bresciani, Pedro Henrique Junqueira e Rafael Eliezer.\033[0m")
                                        break
